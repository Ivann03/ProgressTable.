...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Коневский Артем Владимирович", Visual=1, Architecture=0, Networks=2, Calculate_Math=1, PI=2, Math=1, Electric=1},
                new Student{Name="Ушаков Иван Андреевич", Visual=1, Architecture=1, Networks=2, Calculate_Math=2, PI=2, Math=1, Electric=2},
            };
            CheckAverage(students);
